class DailyLog {
  ...
  final double? lat;
  final double? lng;
  final bool isSynced; // true once this row has been included in a successful Drive backup
  ...
  /// Convenience aliases matching the "latitude" / "longitude" naming used
  /// elsewhere in the app (GPS capture, Drive backup, exports). The
  /// underlying SQLite columns remain `lat` / `lng` for backward
