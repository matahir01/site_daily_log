/// Category of a materials_and_equipment entry.
...
/// A single material delivery or piece of heavy machinery logged against a
/// daily log entry (e.g. "40 bags of cement", "Excavator on site").
class MaterialItem {
  final String id;
  final String logId;
  final String itemName;
  final double quantity;
  final String? unit; // e.g. "bags", "m3", "tonnes", "hrs" (optional for equipment)
