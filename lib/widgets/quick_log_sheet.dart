...
/// Fast-path daily log: snap a photo, tap a weather chip, tap crew count.
/// No typing required to save — text fields are optional extras.
class QuickLogSheet extends StatefulWidget {
  final String siteId;
  const QuickLogSheet({super.key, required this.siteId});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          // Photo row — the primary action, big and obvious
          SizedBox(
            height: 90,
            child: ListView(
